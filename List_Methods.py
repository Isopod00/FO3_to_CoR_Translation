...
""" This file contains useful methods that allow lists to be manipulated like sets. We use these methods to help
determine the free variables of typed FO3 expressions since we are representing typed variables as objects, which are
mutable and thus cannot be stored in a traditional Python set. """
