...
def asZ3(expression):
    match expression:
        ...
        case Predicate():
            return z3.Function(expression.letter, SortForEverything, SortForEverything, z3.BoolSort())(z3.Const(expression.argument1,SortForEverything),z3.Const(expression.argument2,SortForEverything))
